...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full bg-header-1  bg-white shadow-[0px_1px_1px_#0000003f]">
      <div className="w-full bg-global-25 pl-0 pr-4 sm:pr-6 lg:pl-[36px] py-4 sm:py-5 lg:py-[22px]"> <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between w-full gap-4">
